...
public struct ActionQueue : IFlatbufferObject
{
  ...
  public int User { get { int o = __p.__offset(4); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  public static Offset<FlatBuffer.Response.ActionQueue> CreateActionQueue(FlatBufferBuilder builder,
    ...
    ActionQueue.AddUser(builder, user);
  ...
  public static void AddUser(FlatBufferBuilder builder, int user) { builder.AddInt(0, user, 0); }
