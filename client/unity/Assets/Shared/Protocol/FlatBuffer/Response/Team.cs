...
public struct Team : IFlatbufferObject
{
  ...
  public static Offset<FlatBuffer.Response.Team> CreateTeam(FlatBufferBuilder builder,
      VectorOffset usersOffset = default(VectorOffset)) {
    builder.StartTable(1);
    Team.AddUsers(builder, usersOffset);
    return Team.EndTeam(builder);
  }

  public static void StartTeam(FlatBufferBuilder builder) { builder.StartTable(1); }
  ...
  public static Offset<FlatBuffer.Response.Team> EndTeam(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatBuffer.Response.Team>(o);
  }
};
