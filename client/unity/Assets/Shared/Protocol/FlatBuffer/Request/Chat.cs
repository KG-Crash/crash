...
public struct Chat : IFlatbufferObject
{
  ...
  public static Offset<FlatBuffer.Request.Chat> CreateChat(FlatBufferBuilder builder,
  ...
  public static Offset<FlatBuffer.Request.Chat> EndChat(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatBuffer.Request.Chat>(o);
  }
};
