...
public struct Login : IFlatbufferObject
{
  ...
  public static Offset<FlatBuffer.Request.Login> CreateLogin(FlatBufferBuilder builder,
  ...
  public static Offset<FlatBuffer.Request.Login> EndLogin(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatBuffer.Request.Login>(o);
  }
};
